...
void send_packet(int sock , const char * src_ip , const char * dest_ip , uint16_t src_port , uint16_t dst_port , uint32_t seq , uint32_t ack_seq , bool syn , bool ack){
...
int main(){
    ...
    // ---------------- building and sending the SYN Packet -------------------------
    ...
    while(true){
        ...
        // and the packet is destined to our chosen client port.
        ...
        // - the acknowledgment number should be 201 (client seq 200 + 1)
